...
.method public static synthetic a(Ljava/util/Spliterator$OfPrimitive;)Lj$/util/Q;
    ...
    :cond_1
    invoke-static {p0}, Lj$/util/K;->u(Ljava/lang/Object;)Z

    move-result v0

    if-eqz v0, :cond_2

    invoke-static {p0}, Lj$/util/K;->b(Ljava/lang/Object;)Ljava/util/Spliterator$OfDouble;
    ...
    :cond_2
    invoke-static {p0}, Lj$/util/K;->B(Ljava/lang/Object;)Z

    move-result v0

    if-eqz v0, :cond_3

    invoke-static {p0}, Lj$/util/K;->c(Ljava/lang/Object;)Ljava/util/Spliterator$OfInt;
    ...
    invoke-static {p0}, Lj$/util/K;->d(Ljava/lang/Object;)Ljava/util/Spliterator$OfLong;
...
.method public final synthetic forEachRemaining(Ljava/lang/Object;)V
    ...
    invoke-static {v0, p1}, Lj$/util/K;->s(Ljava/util/Spliterator$OfPrimitive;Ljava/lang/Object;)V
...
.method public final synthetic forEachRemaining(Ljava/util/function/Consumer;)V
    ...
    invoke-static {v0, p1}, Lj$/util/K;->t(Ljava/util/Spliterator;Ljava/util/function/Consumer;)V
...
.method public final synthetic tryAdvance(Ljava/lang/Object;)Z
    ...
    invoke-static {v0, p1}, Lj$/util/K;->v(Ljava/util/Spliterator$OfPrimitive;Ljava/lang/Object;)Z
...
.method public final synthetic tryAdvance(Ljava/util/function/Consumer;)Z
    ...
    invoke-static {v0, p1}, Lj$/util/K;->w(Ljava/util/Spliterator;Ljava/util/function/Consumer;)Z
...
.method public final synthetic trySplit()Lj$/util/Q;
    ...
    invoke-static {v0}, Lj$/util/K;->h(Ljava/util/Spliterator$OfPrimitive;)Ljava/util/Spliterator$OfPrimitive;
...
.method public final synthetic trySplit()Lj$/util/Spliterator;
    ...
    invoke-static {v0}, Lj$/util/K;->i(Ljava/util/Spliterator$OfPrimitive;)Ljava/util/Spliterator;
